...
- **Known non-regression**: `test_e2e_processing_dr_svg` times out under Docker-on-macOS. It is CPU-bound nesting against a hard 60s budget and fails identically on unmodified commits — but don't read a run containing it as a green baseline.
